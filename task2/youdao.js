...
define("newweb/common/ZeroClipboard", [], function(e, t) {
    !function(e, t) {
        ...
        var n, r, i, o = e, a = o.document, s = o.navigator, l = o.setTimeout, c = o.clearTimeout, u = o.setInterval, f = o.clearInterval, d = o.getComputedStyle, p = o.encodeURIComponent, h = o.ActiveXObject, m = o.Error, g = o.Number.parseInt || o.parseInt, v = o.Number.parseFloat || o.parseFloat, y = o.Number.isNaN || o.isNaN, b = o.Date.now, x = o.Object.keys, w = o.Object.prototype.hasOwnProperty, T = o.Array.prototype.slice, _ = function() {
        ...
        }, I = null == o.opener && (!!o.top && o != o.top || !!o.parent && o != o.parent), H = "html" === a.documentElement.nodeName, q = {
            bridge: null,
            version: "0.0.0",
            pluginType: "unknown",
            sandboxed: null,
            ...
            swfPath: (D(F()) || R() || "") + "ZeroClipboard.swf",
            ...
            var t = null;
            return (!1 === I || e && "error" === e.type && e.name && -1 !== X.indexOf(e.name)) && (t = !1),
            t
        }, Te = function(e) {
...
define("newweb/common/account", ["./log"], function(e, t) {
    ...
    function r() {
        var e = window.location.protocol + "//" + window.location.host + "/login?method=login"
          , t = window.location.protocol + "//" + window.location.host + "/login?method=loginCallback"
          , n = '<iframe id="loginFrame" class="boxIframe" width="400px" height="415" frameborder="0" src="' + (e + "#" + encodeURIComponent(t) + "#loginSuccess") + '" scrolling="no"></iframe>';
        i("#loginWindow .content").append(n),
    ...
    t.init = function() {
        if (r(),
        o.find(".dialog-alert--close").on("click", function() {
            n()
        }),
        o.find(".cancel, .ok").on("click", function() {
            n()
        }),
        i(".login-link").on("click", function() {
            l.clog("LOGIN_CLICK", ""),
            a.show(),
            s.show()
        }),
        s.find(".dialog-alert--close").on("click", function() {
            a.hide(),
            s.hide()
        }),
        i(".login-out").length > 0) {
            var e = i(".login-out").attr("href");
            e += window.encodeURIComponent(window.location.href),
            i(".login-out").attr("href", e)
        }
    }
    ,
    ...
    t.init = function() {
        ...
        x.on("change", function() {
            ...
            "" != (i = e && e[0] && e[0].name ? e[0].name : i.split("\\")[i.split("\\").length - 1])) {
                if (!/(.doc|.docx|.pdf)$/i.test(i))
                    return o(!0, {
                        msg: "格式错误，请使用docx／doc／pdf格式",
                        name: i,
                        size: r(n)
                    }),
    ...
    !function(t) {
        ...
        e.fn.ajaxSubmit = function(t, n, i, s) {
            ...
            function c(n) {
                        ...
                        if (O && O.location.href !== f.iframeSrc || w) {
                            ...
                            try {
                                ...
                                if (u || f.textarea) {
                                    ...
                                    "xml" === c && !y.responseXML && y.responseText && (y.responseXML = R(y.responseText));
                                try {
                                    D = I(y, c, f)
                                } catch (e) {
                                    o = "parsererror",
                ...
                var D, O, L, F = 50, R = e.parseXML || function(e, t) {
                ...
                , I = function(t, n, r) {
                    ...
                    "string" == typeof a && (("json" === n || !n) && i.indexOf("json") >= 0 ? a = M(a) : ("script" === n || !n) && i.indexOf("javascript") >= 0 && e.globalEval(a)),
                    a
                };
                return C
            }
...
define("newweb/common/jquery-1.7", [], function(e, t) {
    return function(e, t) {
        ...
        function r(e, n, r) {
            if (r === t && 1 === e.nodeType) {
                ...
                if ("string" == typeof (r = e.getAttribute(i))) {
                    try {
                        r = "true" === r || "false" !== r && ("null" === r ? null : R.isNumeric(r) ? parseFloat(r) : H.test(r) ? R.parseJSON(r) : r)
                    } catch (e) {}
                    R.data(e, n, r)
                } else
                    r = t
        ...
        function i(e) {
            for (var t in e)
                if (("data" !== t || !R.isEmptyObject(e[t])) && "toJSON" !== t)
                    return !1;
            return !0
        }
        function o(e, t, n) {
            ...
            !a || "queue" !== n && R._data(e, i) || "mark" !== n && R._data(e, o) || setTimeout(function() {
                R._data(e, i) || R._data(e, o) || (R.removeData(e, r, !0),
                a.fire())
            }, 0)
        }
        function a() {
            ...
            if (1 === t.nodeType && R.hasData(e)) {
                ...
                if (s) {
                    ...
                    for (n in s)
                        for (r = 0,
                        i = s[n].length; r < i; r++)
                            R.event.add(t, n + (s[n][r].namespace ? "." : "") + s[n][r].namespace, s[n][r], s[n][r].data)
                }
        ...
        function v(e, t) {
            t.src ? R.ajax({
                ...
                async: !1,
                dataType: "script"
            }) : R.globalEval((t.text || t.textContent || t.innerHTML || "").replace(Se, "/*$0*/")),
            t.parentNode && t.parentNode.removeChild(t)
        }
        function y(e, t, n) {
            ...
            return r > 0 ? ("border" !== n && R.each(i, function() {
                n || (r -= parseFloat(R.css(e, "padding" + this)) || 0),
                "margin" === n ? r += parseFloat(R.css(e, n + this)) || 0 : r -= parseFloat(R.css(e, "border" + this + "Width")) || 0
            }),
            r + "px") : (((r = je(e, t, t)) < 0 || null == r) && (r = e.style[t] || 0),
            r = parseFloat(r) || 0,
            n && R.each(i, function() {
                r += parseFloat(R.css(e, "padding" + this)) || 0,
                "padding" !== n && (r += parseFloat(R.css(e, "border" + this + "Width")) || 0),
                "margin" === n && (r += parseFloat(R.css(e, n + this)) || 0)
            }),
            r + "px")
        }
        function b(e) {
        ...
        function C(e, n) {
            ...
            for (r = 1; r < p; r++) {
                ...
                "*" === (h = f[r]))
                    ...
                    l || u || R.error("No conversion from " + s.replace(" ", " to ")),
                    !0 !== l && (n = l ? l(n) : u(c(n)))
                }
            }
            return n
        ...
        var O = e.document
          ...
          , R = function() {
            ...
            }, E = L.userAgent, j = Object.prototype.toString, N = Object.prototype.hasOwnProperty, A = Array.prototype.push, D = Array.prototype.slice, F = String.prototype.trim, R = Array.prototype.indexOf, M = {};
        ...
        R.Callbacks = function(e) {
            ...
            var r, i, o, a, s, l = [], c = [], u = function(t) {
                ...
                r = t.length; n < r; n++)
                    i = t[n],
                    "array" === (o = R.type(i)) ? u(i) : "function" === o && (e.unique && d.has(i) || l.push(i))
            }, f = function(t, n) {
                for (n = n || [],
                r = !e.memory || [t, n],
                i = !0,
        ...
        R.extend({
            Deferred: function(e) {
                var t, n = R.Callbacks("once memory"), r = R.Callbacks("once memory"), i = R.Callbacks("memory"), o = "pending", a = {
                    resolve: n,
                    reject: r,
                    notify: i
                }, s = {
            ...
            when: function(e) {
                ...
                if (r > 1) {
                    for (; n < r; n++)
                        t[n] && t[n].promise && R.isFunction(t[n].promise) ? t[n].promise().then(function(e) {
                            return function(n) {
                                t[e] = arguments.length > 1 ? I.call(arguments, 0) : n,
                                --o || a.resolveWith(a, t)
                            }
        ...
        R.extend({
            ...
            data: function(e, n, r, i) {
                if (R.acceptData(e)) {
                    R.expando;
                    var o, a, s, l = "string" == typeof n, c = e.nodeType, u = c ? R.cache : e, f = c ? e[R.expando] : e[R.expando] && R.expando, d = "events" === n;
                    if (f && u[f] && (d || i || u[f].data) || !l || r !== t)
                        return f || (c ? e[R.expando] = f = ++R.uuid : f = R.expando),
                        u[f] || (u[f] = {},
                        c || (u[f].toJSON = R.noop)),
                        "object" != typeof n && "function" != typeof n || (i ? u[f] = R.extend(u[f], n) : u[f].data = R.extend(u[f].data, n)),
                        o = a = u[f],
                        i || (a.data || (a.data = {}),
                        a = a.data),
                        r !== t && (a[R.camelCase(n)] = r),
                        d && !a[n] ? o.events : (l ? null == (s = a[n]) && (s = a[R.camelCase(n)]) : s = a,
                        s)
                }
            },
                ...
                if (R.acceptData(e)) {
                    ...
                    if (l[c]) {
                        if (t && (r = n ? l[c] : l[c].data)) {
                            for ((o = 0,
                            a = (t = R.isArray(t) ? t : t in r ? [t] : (t = R.camelCase(t))in r ? [t] : t.split(" ")).length); o < a; o++)
                                delete r[t[o]];
                            if (!(n ? i : R.isEmptyObject)(r))
                                return
                        }
                        (n || (delete l[c].data,
                        i(l[c]))) && (R.support.deleteExpando || !l.setInterval ? delete l[c] : l[c] = null,
                        s && (R.support.deleteExpando ? delete e[R.expando] : e.removeAttribute ? e.removeAttribute(R.expando) : e[R.expando] = null))
                    }
                }
            },
        ...
        R.fn.extend({
            data: function(e, n) {
                var i, o, a, s = null;
                if (void 0 === e) {
                    if (this.length && (s = R.data(this[0]),
                    1 === this[0].nodeType && !R._data(this[0], "parsedAttrs"))) {
                        for (var l = 0, c = (o = this[0].attributes).length; l < c; l++)
                            0 === (a = o[l].name).indexOf("data-") && (a = R.camelCase(a.substring(5)),
                            r(this[0], a, s[a]));
                ...
                i[1] = i[1] ? "." + i[1] : "",
                n === t ? ((s = this.triggerHandler("getData" + i[1] + "!", [i[0]])) === t && this.length && (s = R.data(this[0], e),
                s = r(this[0], e, s)),
        ...
        R.extend({
            ...
            _unmark: function(e, t, n) {
                ...
                t) {
                    ...
                    i ? R._data(t, r, i) : (R.removeData(t, r, !0),
                    o(t, n, "mark"))
                }
            },
            queue: function(e, t, n) {
                ...
                if (e)
                    return t = (t || "fx") + "queue",
                    r = R._data(e, t),
                    n && (!r || R.isArray(n) ? r = R._data(e, t, R.makeArray(n)) : r.push(n)),
                    r || []
            },
            dequeue: function(e, t) {
                ...
                n.length || (R.removeData(e, t + "queue " + t + ".run", !0),
                o(e, t, "queue"))
            }
        }),
        R.fn.extend({
            queue: function(e, n) {
                ...
                e = "fx"),
                n === t ? R.queue(this[0], e) : this.each(function() {
            ...
            delay: function(e, t) {
                return e = R.fx ? R.fx.speeds[e] || e : e,
                t = t || "fx",
            ...
            promise: function(e, n) {
                ...
                e = t),
                e = e || "fx";
                for (var i, o = R.Deferred(), a = this, s = a.length, l = 1, c = e + "defer", u = e + "queue", f = e + "mark"; s--; )
                    (i = R.data(a[s], c, t, !0) || (R.data(a[s], u, t, !0) || R.data(a[s], f, t, !0)) && R.data(a[s], c, R.Callbacks("once memory"), !0)) && (l++,
                    i.add(r));
                return r(),
                o.promise()
            }
        });
        var P, B, z, U = /[\n\t\r]/g, $ = /\s+/, W = /\r/g, X = /^(?:button|input)$/i, V = /^(?:button|input|object|select|textarea)$/i, Y = /^a(?:rea)?$/i, Z = /^(?:autofocus|autoplay|async|checked|controls|defer|disabled|hidden|loop|multiple|open|readonly|required|scoped|selected)$/i, K = R.support.getSetAttribute;
        R.fn.extend({
            attr: function(e, t) {
            ...
            toggleClass: function(e, t) {
                ...
                return R.isFunction(e) ? this.each(function(n) {
                    ...
                    if ("string" === n)
                        for (var i, o = 0, a = R(this), s = t, l = e.split($); i = l[o++]; )
                            a[(s = r ? s : !a.hasClass(i)) ? "addClass" : "removeClass"](i);
                    else
                        "undefined" !== n && "boolean" !== n || (this.className && R._data(this, "__className__", this.className),
                        this.className = this.className || !1 === e ? "" : R._data(this, "__className__") || "")
                })
            },
            hasClass: function(e) {
            ...
            val: function(e) {
                var n, r, i, o = this[0];
                return arguments.length ? (i = R.isFunction(e),
        ...
        R.extend({
            ...
            attr: function(e, n, r, i) {
                ...
                return e && 3 !== l && 8 !== l && 2 !== l ? i && n in R.attrFn ? R(e)[n](r) : "getAttribute"in e ? ((s = 1 !== l || !R.isXMLDoc(e)) && (n = n.toLowerCase(),
                a = R.attrHooks[n] || (Z.test(n) ? B : P)),
                r !== t ? null === r ? (R.removeAttr(e, n),
                t) : a && "set"in a && s && (o = a.set(e, r, n)) !== t ? o : (e.setAttribute(n, "" + r),
                r) : a && "get"in a && s && null !== (o = a.get(e, n)) ? o : null === (o = e.getAttribute(n)) ? t : o) : R.prop(e, n, r) : t
            },
            ...
            prop: function(e, n, r) {
                ...
                return e && 3 !== a && 8 !== a && 2 !== a ? ((1 !== a || !R.isXMLDoc(e)) && (n = R.propFix[n] || n,
                o = R.propHooks[n]),
        ...
        B = {
            ...
            set: function(e, t, n) {
                var r;
                return !1 === t ? R.removeAttr(e, n) : ((r = R.propFix[n] || n)in e && (e[r] = !0),
        ...
        R.attrHooks.tabindex.set = P.set,
        ...
        R.each(["radio", "checkbox"], function() {
            R.valHooks[this] = R.extend(R.valHooks[this], {
                set: function(e, t) {
                    if (R.isArray(t))
                        return e.checked = R.inArray(R(e).val(), t) >= 0
                }
            })
        });
        ...
        R.event = {
            add: function(e, n, r, i, o) {
                ...
                if (3 !== e.nodeType && 8 !== e.nodeType && n && r && (a = R._data(e))) {
                    ...
                    c = 0; c < n.length; c++)
                        ...
                        o && (p.quick = re(o),
                        !p.quick && R.expr.match.POS.test(o) && (p.isPositional = !0)),
                ...
                if (m && (u = m.events)) {
                    ...
                    i = 0; i < t.length; i++) {
                        ...
                        !a) {
                            s = s ? "." + s : "";
                            for (c in u)
                                R.event.remove(e, c + s, n, r);
                            return
                        }
                        if (f = R.event.special[a] || {},
                        ...
                        n || s || r || f.remove)
                            ...
                            p.length = 0;
                        0 === p.length && l !== p.length && (f.teardown && !1 !== f.teardown.call(e, s) || R.removeEvent(e, a, m.handle),
                        delete u[a])
                    }
                    R.isEmptyObject(u) && ((d = m.handle) && (d.elem = null),
                    R.removeData(e, ["events", "handle"], !0))
                }
            },
            customEvent: {
                getData: !0,
            ...
            trigger: function(n, r, i, o) {
                if (!i || 3 !== i.nodeType && 8 !== i.nodeType) {
                    ...
                    v.sort()),
                    i && !R.event.customEvent[g] || R.event.global[g])
                        if (n = "object" == typeof n ? n[R.expando] ? n : new R.Event(g,n) : new R.Event(g),
                        n.type = g,
                        n.isTrigger = !0,
                        n.exclusive = s,
                        n.namespace = v.join("."),
                        ...
                        i) {
                            if (n.result = t,
                            n.target || (n.target = i),
                            (r = null != r ? R.makeArray(r) : []).unshift(n),
                            !(d = R.event.special[g] || {}).trigger || !1 !== d.trigger.apply(i, r)) {
                                if (h = [[i, d.bindType || g]],
                                !o && !d.noBubble && !R.isWindow(i)) {
                                ...
                                n.type = h[l][1],
                                (p = (R._data(c, "events") || {})[n.type] && R._data(c, "handle")) && p.apply(c, r),
                                (p = f && c[f]) && R.acceptData(c) && p.apply(c, r),
                                !n.isPropagationStopped()); l++)
                                    ;
                                return n.type = g,
                                n.isDefaultPrevented() || d._default && !1 !== d._default.apply(i.ownerDocument, r) || "click" === g && R.nodeName(i, "a") || !R.acceptData(i) || f && i[g] && ("focus" !== g && "blur" !== g || 0 !== n.target.offsetWidth) && !R.isWindow(i) && ((u = i[f]) && (i[f] = null),
                                R.event.triggered = g,
                                i[g](),
                                R.event.triggered = t,
                                u && (i[f] = u)),
                            ...
                            a = R.cache;
                            for (l in a)
                                a[l].events && a[l].events[g] && R.event.trigger(n, r, a[l].handle.elem, !0)
                        }
                }
            },
            dispatch: function(n) {
                n = R.event.fix(n || e.event);
                var r, i, o, a, s, l, c, u, f, d, p = (R._data(this, "events") || {})[n.type] || [], h = p.delegateCount, m = [].slice.call(arguments, 0), g = !n.exclusive && !n.namespace, v = (R.event.special[n.type] || {}).handle, y = [];
                if (m[0] = n,
                ...
                h && !n.target.disabled && (!n.button || "click" !== n.type))
                    for (o = n.target; o != this; o = o.parentNode || this) {
                        ...
                        r = 0; r < h; r++)
                            ...
                            u.isPositional ? d = (d || (s[f] = R(f))).index(o) >= 0 : d === t && (d = s[f] = u.quick ? ie(o, u.quick) : R(o).is(f)),
                            d && c.push(u);
                        c.length && y.push({
                            elem: o,
                            matches: c
            ...
            fix: function(e) {
                if (e[R.expando])
                    return e;
                var n, r, i = e, o = R.event.fixHooks[e.type] || {}, a = o.props ? this.props.concat(o.props) : this.props;
                for (e = R.Event(i),
                n = a.length; n; )
                    e[r = a[--n]] = i[r];
            ...
            simulate: function(e, t, n, r) {
                ...
                r ? R.event.trigger(i, null, t) : R.event.dispatch.call(t, i),
                i.isDefaultPrevented() && n.preventDefault()
            }
        },
        R.event.handle = R.event.dispatch,
        R.removeEvent = O.removeEventListener ? function(e, t, n) {
        ...
        R.Event = function(e, t) {
            ...
            t && R.extend(this, t),
            this.timeStamp = e && e.timeStamp || R.now(),
            this[R.expando] = !0
        }
        ,
        R.Event.prototype = {
        ...
        R.each({
            ...
            R.event.special[e] = R.event.special[t] = {
                ...
                handle: function(e) {
                    ...
                    o.selector;
                    return i && o.origType !== e.type && (i === r || R.contains(r, i)) || (t = e.type,
                    e.type = o.origType,
        ...
        R.support.changeBubbles || (R.event.special.change = {
            setup: function() {
                if (G.test(this.nodeName))
                    return "checkbox" !== this.type && "radio" !== this.type || (R.event.add(this, "propertychange._change", function(e) {
                        "checked" === e.originalEvent.propertyName && (this._just_changed = !0)
                    }),
                    R.event.add(this, "click._change", function(e) {
                        this._just_changed && (this._just_changed = !1,
                        R.event.simulate("change", this, e, !0))
                    })),
                    !1;
        ...
        R.fn.extend({
            ...
            off: function(e, n, r) {
                if (e && e.preventDefault && e.handleObj) {
                    var i = e.handleObj;
                    return R(e.delegateTarget).off(i.namespace ? i.type + "." + i.namespace : i.type, i.selector, i.handler),
                    this
                }
                if ("object" == typeof e) {
                    for (var o in e)
            ...
            live: function(e, t, n) {
                return R(this.context).on(e, this.selector, t, n),
                this
            },
            die: function(e, t) {
                return R(this.context).off(e, this.selector || "**", t),
                this
            },
            ...
            triggerHandler: function(e, t) {
                if (this[0])
                    return R.event.trigger(e, t, this[0], !0)
            },
            toggle: function(e) {
                var t = arguments
                  , n = e.guid || R.guid++
                  ...
                  , i = function(n) {
                    ...
                    return R._data(this, "lastToggle" + e.guid, i + 1),
                    n.preventDefault(),
        ...
        R.each("blur focus focusin focusout load resize scroll unload click dblclick mousedown mouseup mousemove mouseover mouseout mouseenter mouseleave change select submit keydown keypress keyup error contextmenu".split(" "), function(e, t) {
            ...
            ee.test(t) && (R.event.fixHooks[t] = R.event.keyHooks),
            te.test(t) && (R.event.fixHooks[t] = R.event.mouseHooks)
        }),
        function() {
            ...
            R.unique = d.uniqueSort,
            R.text = d.getText,
            R.isXMLDoc = d.isXML,
            R.contains = d.contains
        }();
        var ae = /Until$/
        ...
        R.fn.extend({
            find: function(e) {
                var t, n, r = this;
                if ("string" != typeof e)
                    return R(e).filter(function() {
                        for (t = 0,
                        n = r.length; t < n; t++)
                            if (R.contains(r[t], this))
                                return !0
                    });
            ...
            closest: function(e, t) {
                ...
                return i = i.length > 1 ? R.unique(i) : i,
        ...
        R.each({
            ...
            R.fn[e] = function(n, r) {
                ...
                r && "string" == typeof r && (i = R.filter(r, i)),
                i = this.length > 1 && !de[e] ? R.unique(i) : i,
        ...
        R.extend({
            filter: function(e, t, n) {
                return n && (e = ":not(" + e + ")"),
                1 === t.length ? R.find.matchesSelector(t[0], e) ? [t[0]] : [] : R.find.matches(e, t)
            },
            dir: function(e, n, r) {
                for (var i = [], o = e[n]; o && 9 !== o.nodeType && (r === t || 1 !== o.nodeType || !R(o).is(r)); )
        ...
        ke.th = ke.td,
        R.support.htmlSerialize || (ke._default = [1, "div<div>", "</div>"]),
        R.fn.extend({
            text: function(e) {
            ...
            after: function() {
                ...
                if (arguments.length) {
                    ...
                    return e.push.apply(e, R(arguments[0]).toArray()),
                    e
                }
            },
            remove: function(e, t) {
                for (var n, r = 0; null != (n = this[r]); r++)
                    e && !R.filter(e, [n]).length || (t || 1 !== n.nodeType || (R.cleanData(n.getElementsByTagName("*")),
                    R.cleanData([n])),
            ...
            empty: function() {
                for (var e, t = 0; null != (e = this[t]); t++)
                    for (1 === e.nodeType && R.cleanData(e.getElementsByTagName("*")); e.firstChild; )
            ...
            html: function(e) {
                ...
                if ("string" != typeof e || xe.test(e) || !R.support.leadingWhitespace && me.test(e) || ke[(ve.exec(e) || ["", ""])[1].toLowerCase()])
                    R.isFunction(e) ? this.each(function(t) {
                        var n = R(this);
                    ...
                    try {
                        for (var n = 0, r = this.length; n < r; n++)
                            1 === this[n].nodeType && (R.cleanData(this[n].getElementsByTagName("*")),
                            this[n].innerHTML = e)
                    } catch (t) {
                        this.empty().append(e)
                    }
            ...
            replaceWith: function(e) {
                ...
                }) : ("string" != typeof e && (e = R(e).detach()),
                this.each(function() {
                    var t = this.nextSibling
                      , n = this.parentNode;
                    R(this).remove(),
                    t ? R(t).before(e) : R(n).append(e)
            ...
            domManip: function(e, n, r) {
                var i, o, a, s, l = e[0], c = [];
                if (!R.support.checkClone && 3 === arguments.length && "string" == typeof l && _e.test(l))
                    return this.each(function() {
                ...
                if (this[0]) {
                    if (s = l && l.parentNode,
                    i = R.support.parentNode && s && 11 === s.nodeType && s.childNodes.length === this.length ? {
                        fragment: s
                    } : R.buildFragment(e, this, c),
                    a = i.fragment,
                    o = 1 === a.childNodes.length ? a = a.firstChild : a.firstChild) {
                        n = n && R.nodeName(o, "tr");
                        for (var u = 0, d = this.length, p = d - 1; u < d; u++)
                            r.call(n ? f(this[u]) : this[u], i.cacheable || d > 1 && u < p ? R.clone(a, !0, !0) : a)
                    }
                    c.length && R.each(c, v)
                }
                return this
        ...
        R.buildFragment = function(e, t, n) {
            ...
            1 === e.length && "string" == typeof s && s.length < 512 && a === O && "<" === s.charAt(0) && !we.test(s) && (R.support.checkClone || !_e.test(s)) && !R.support.unknownElems && Te.test(s) && (i = !0,
            (o = R.fragments[s]) && 1 !== o && (r = o)),
            r || (r = a.createDocumentFragment(),
            R.clean(e, a, r, n)),
            i && (R.fragments[s] = o ? r : 1),
            {
                fragment: r,
                cacheable: i
            }
                            ...
                            if (be.test(a)) {
                                ...
                                if (!R.support.tbody) {
                                    ...
                                    for (o = m.length - 1; o >= 0; --o)
                                        R.nodeName(m[o], "tbody") && !m[o].childNodes.length && m[o].parentNode.removeChild(m[o])
                                }
                                !R.support.leadingWhitespace && me.test(a) && p.insertBefore(t.createTextNode(me.exec(a)[0]), p.firstChild),
                                a = p.childNodes
                            } else
                    ...
                    if ((!r.nodeName || !R.noData[r.nodeName.toLowerCase()]) && (n = r[R.expando])) {
                        if ((t = i[n]) && t.events) {
                            for (var l in t.events)
                                o[l] ? R.event.remove(r, l) : R.removeEvent(r, l, t.handle);
                            t.handle && (t.handle.elem = null)
                        }
                        a ? delete r[R.expando] : r.removeAttribute && r.removeAttribute(R.expando),
                        delete i[n]
                    }
            }
        });
        var je, Ne, Ae, De = /alpha\([^)]*\)/i, Oe = /opacity=([^)]*)/, Le = /([A-Z]|^ms)/g, Fe = /^-?\d+(?:px)?$/i, Re = /^-?\d/, Me = /^([\-+])=([\-+.\de]+)/, Ie = {
            position: "absolute",
            visibility: "hidden",
            display: "block"
        }, He = ["Left", "Right"], qe = ["Top", "Bottom"];
        ...
        R.extend({
            ...
            style: function(e, n, r, i) {
                if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                    ...
                    if (!("string" == (a = typeof r) && (o = Me.exec(r)) && (r = +(o[1] + 1) * +o[2] + parseFloat(R.css(e, n)),
                    a = "number"),
                    null == r || "number" === a && isNaN(r) || ("number" !== a || R.cssNumber[s] || (r += "px"),
            ...
            css: function(e, n, r) {
                var i, o;
                return n = R.camelCase(n),
                o = R.cssHooks[n],
                "cssFloat" === (n = R.cssProps[n] || n) && (n = "float"),
        ...
        R.each(["height", "width"], function(e, t) {
            R.cssHooks[t] = {
                get: function(e, n, r) {
                    var i;
                    if (n)
                        return 0 !== e.offsetWidth ? y(e, t, r) : (R.swap(e, Ie, function() {
                            i = y(e, t, r)
                        }),
                        i)
                },
        ...
        R.support.opacity || (R.cssHooks.opacity = {
            ...
            set: function(e, t) {
                ...
                n.zoom = 1,
                t >= 1 && "" === R.trim(o.replace(De, "")) && (n.removeAttribute("filter"),
        ...
        O.defaultView && O.defaultView.getComputedStyle && (Ne = function(e, n) {
            ...
            (i = e.ownerDocument.defaultView) ? ((o = i.getComputedStyle(e, null)) && ("" !== (r = o.getPropertyValue(n)) || R.contains(e.ownerDocument.documentElement, e) || (r = R.style(e, n))),
            r) : t
        }
        ),
        ...
        var Pe, Be, ze = /%20/g, Ue = /\[\]$/, $e = /\r?\n/g, We = /#.*$/, Xe = /^(.*?):[ \t]*([^\r\n]*)\r?$/gm, Ve = /^(?:color|date|datetime|datetime-local|email|hidden|month|number|password|range|search|tel|text|time|url|week)$/i, Ye = /^(?:about|app|app\-storage|.+\-extension|file|res|widget):$/, Ze = /^(?:GET|HEAD)$/, Ke = /^\/\//, Ge = /\?/, Je = /<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi, Qe = /^(?:select|textarea)/i, et = /\s+/, tt = /([?&])_=[^&]*/, nt = /^([\w\+\.\-]+:)(?:\/\/([^\/?#:]*)(?::(\d+))?)?/, rt = R.fn.load, it = {}, ot = {}, at = ["*/"] + ["*"];
        try {
            Pe = F.href
        } catch (e) {
        ...
        R.fn.extend({
            load: function(e, n, r) {
                ...
                var a = "GET";
                n && (R.isFunction(n) ? (r = n,
                n = t) : "object" == typeof n && (n = R.param(n, R.ajaxSettings.traditional),
                a = "POST"));
                var s = this;
                return R.ajax({
                    url: e,
                    ...
                    complete: function(e, t, n) {
                        ...
                        s.html(o ? R("<div>").append(n.replace(Je, "")).find(o) : n)),
                        r && s.each(r, [n, t, e])
                    }
                }),
                this
        ...
        R.extend({
            ...
            ajaxSetup: function(e, t) {
                return t ? w(e, R.ajaxSettings) : (t = e,
                e = R.ajaxSettings),
                w(e, t),
                e
            },
            ...
            ajax: function(e, n) {
                function r(e, n, r, a) {
                    if (2 !== w) {
                        ...
                        if (e >= 200 && e < 300 || 304 === e)
                            if (d.ifModified && ((b = T.getResponseHeader("Last-Modified")) && (R.lastModified[i] = b),
                            (x = T.getResponseHeader("Etag")) && (R.etag[i] = x)),
                            304 === e)
                                S = "notmodified",
                                c = !0;
                            else
                ...
                e = t),
                n = n || {};
                var i, o, a, s, l, c, u, f, d = R.ajaxSetup({}, n), p = d.context || d, h = p !== d && (p.nodeType || p instanceof R) ? R(p) : R.event, m = R.Deferred(), g = R.Callbacks("once memory"), v = d.statusCode || {}, y = {}, b = {}, w = 0, T = {
                    readyState: 0,
                ...
                d.dataTypes = R.trim(d.dataType || "*").toLowerCase().split(et),
                ...
                d.data && d.processData && "string" != typeof d.data && (d.data = R.param(d.data, d.traditional)),
                x(it, d, n, T),
                2 === w)
                    return !1;
                if (u = d.global,
                ...
                u && 0 == R.active++ && R.event.trigger("ajaxStart"),
                ...
                R.lastModified[i] && T.setRequestHeader("If-Modified-Since", R.lastModified[i]),
                R.etag[i] && T.setRequestHeader("If-None-Match", R.etag[i])),
            ...
            param: function(e, n) {
                ...
                if (n === t && (n = R.ajaxSettings.traditional),
                R.isArray(e) || e.jquery && !R.isPlainObject(e))
                    R.each(e, function() {
        ...
        R.ajaxPrefilter("json jsonp", function(t, n, r) {
            ...
            if ("jsonp" === t.dataTypes[0] || !1 !== t.jsonp && (lt.test(t.url) || i && lt.test(t.data))) {
                var o, a = t.jsonpCallback = R.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, s = e[a], l = t.url, c = t.data, u = "$1" + a + "$2";
                ...
                r.always(function() {
                    e[a] = s,
                    o && R.isFunction(s) && e[a](o[0])
                }),
                t.converters["script json"] = function() {
                    return o || R.error(a + " was not called"),
                    o[0]
                }
                ,
                t.dataTypes[0] = "json",
        ...
        R.support.ajax && R.ajaxTransport(function(n) {
        ...
        R.fn.extend({
            show: function(e, t, n) {
                ...
                for (var o = 0, a = this.length; o < a; o++)
                    ...
                    R._data(r, "olddisplay") || "none" !== i || (i = r.style.display = ""),
                    "" === i && "none" === R.css(r, "display") && R._data(r, "olddisplay", A(r.nodeName)));
                for (o = 0; o < a; o++)
                    (r = this[o]).style && ("" !== (i = r.style.display) && "none" !== i || (r.style.display = R._data(r, "olddisplay") || ""));
                return this
            },
            hide: function(e, t, n) {
                if (e || 0 === e)
                ...
                for (var r, i, o = 0, a = this.length; o < a; o++)
                    (r = this[o]).style && ("none" === (i = R.css(r, "display")) || R._data(r, "olddisplay") || R._data(r, "olddisplay", i));
                for (o = 0; o < a; o++)
            ...
            animate: function(e, t, n, r) {
                function i() {
                    ...
                    var t, n, r, i, a, s, l, c, u, f = R.extend({}, o), d = 1 === this.nodeType, p = d && R(this).is(":hidden");
                    ...
                    for (r in e) {
                        ...
                        delete e[r]),
                        n = e[t],
                        R.isArray(n) ? (f.animatedProperties[t] = n[1],
                        ...
                        "inline" === R.css(this, "display") && "none" === R.css(this, "float") && (R.support.inlineBlockNeedsLayout && "inline" !== A(this.nodeName) ? this.style.zoom = 1 : this.style.display = "inline-block"))
                    }
                    null != f.overflow && (this.style.overflow = "hidden");
                    for (r in e)
                        i = new R.fx(this,f,r),
                        n = e[r],
                        vt.test(n) ? (u = R._data(this, "toggle" + r) || ("toggle" === n ? p ? "show" : "hide" : 0)) ? (R._data(this, "toggle" + r, "show" === u ? "hide" : "show"),
                        i[u]()) : i[n]() : (a = yt.exec(n),
                        s = i.cur(),
                        a ? (l = parseFloat(a[2]),
                        "px" !== (c = a[3] || (R.cssNumber[r] ? "" : "px")) && (R.style(this, r, (l || 1) + c),
                        s = (l || 1) / i.cur() * s,
                        R.style(this, r, s + c)),
                        a[1] && (l = ("-=" === a[1] ? -1 : 1) * l + s),
                ...
                var o = R.speed(t, n, r);
                return R.isEmptyObject(e) ? this.each(o.complete, [!1]) : (e = R.extend({}, e),
        ...
        R.extend({
            speed: function(e, t, n) {
                ...
                return r.duration = R.fx.off ? 0 : "number" == typeof r.duration ? r.duration : r.duration in R.fx.speeds ? R.fx.speeds[r.duration] : R.fx.speeds._default,
                null != r.queue && !0 !== r.queue || (r.queue = "fx"),
                r.old = r.complete,
                r.complete = function(e) {
                    R.isFunction(r.old) && r.old.call(this),
                    r.queue ? R.dequeue(this, r.queue) : !1 !== e && R._unmark(this)
                }
                ,
                r
            },
        ...
        R.fx.prototype = {
            ...
            custom: function(e, n, r) {
                ...
                this.unit = r || this.unit || (R.cssNumber[this.prop] ? "" : "px"),
            ...
            show: function() {
                ...
                this.options.orig[this.prop] = e || R.style(this.elem, this.prop),
                this.options.show = !0,
            ...
            step: function(e) {
                ...
                if (e || i >= s.duration + this.startTime) {
                    ...
                    if (o) {
                        ...
                        s.hide || s.show)
                            for (t in s.animatedProperties)
                                R.style(a, t, s.orig[t]),
                                R.removeData(a, "fxshow" + t, !0),
                                R.removeData(a, "toggle" + t, !0);
                ...
                this.pos = R.easing[s.animatedProperties[this.prop]](this.state, n, 0, 1, s.duration),
        ...
        R.extend(R.fx, {
            tick: function() {
                for (var e, t = R.timers, n = 0; n < t.length; n++)
        ...
        : R.fn.offset = function(e) {
            ...
            if (t === t.ownerDocument.body)
                return R.offset.bodyOffset(t);
            for (var n, r = t.offsetParent, i = t.ownerDocument, o = i.documentElement, a = i.body, s = i.defaultView, l = s ? s.getComputedStyle(t, null) : t.currentStyle, c = t.offsetTop, u = t.offsetLeft; (t = t.parentNode) && t !== a && t !== o && (!R.support.fixedPosition || "fixed" !== l.position); )
                n = s ? s.getComputedStyle(t, null) : t.currentStyle,
                c -= t.scrollTop,
                u -= t.scrollLeft,
                t === r && (c += t.offsetTop,
                u += t.offsetLeft,
                !R.support.doesNotAddBorder || R.support.doesAddBorderForTableAndCells && xt.test(t.nodeName) || (c += parseFloat(n.borderTopWidth) || 0,
                u += parseFloat(n.borderLeftWidth) || 0),
                r,
                r = t.offsetParent),
                R.support.subtractsBorderForOverflowNotVisible && "visible" !== n.overflow && (c += parseFloat(n.borderTopWidth) || 0,
                u += parseFloat(n.borderLeftWidth) || 0),
                l = n;
            return "relative" !== l.position && "static" !== l.position || (c += a.offsetTop,
            u += a.offsetLeft),
            R.support.fixedPosition && "fixed" === l.position && (c += Math.max(o.scrollTop, a.scrollTop),
        ...
        R.offset = {
            bodyOffset: function(e) {
                var t = e.offsetTop
                  , n = e.offsetLeft;
                return R.support.doesNotIncludeMarginInBodyOffset && (t += parseFloat(R.css(e, "marginTop")) || 0,
            ...
            setOffset: function(e, t, n) {
                ...
                ("absolute" === r || "fixed" === r) && R.inArray("auto", [l, c]) > -1 ? (i = (f = a.position()).top,
                o = f.left) : (i = parseFloat(l) || 0,
                o = parseFloat(c) || 0),
                R.isFunction(t) && (t = t.call(e, n, s)),
        ...
        R.fn.extend({
            position: function() {
                ...
                return n.top -= parseFloat(R.css(e, "marginTop")) || 0,
                n.left -= parseFloat(R.css(e, "marginLeft")) || 0,
                r.top += parseFloat(R.css(t[0], "borderTopWidth")) || 0,
                r.left += parseFloat(R.css(t[0], "borderLeftWidth")) || 0,
                {
                    top: n.top - r.top,
                    left: n.left - r.left
                }
            ...
            offsetParent: function() {
                return this.map(function() {
                    for (var e = this.offsetParent || O.body; e && !wt.test(e.nodeName) && "static" === R.css(e, "position"); )
                        e = e.offsetParent;
                    return e
                })
            }
...
define("newweb/common/translate", ["./utils", "./voice", "./TranslateState", "./log", "./service", "./md5", "./jquery-1.7", "./smartResult", "./requestMoreTrans"], function(e, t) {
    function n() {
        ...
        var e = u("#inputOriginal").height()
          , t = u("#transTarget").height()
          , n = Math.max(e, t);
        u("#inputOriginal").css("height", n),
        u("#transTarget").css("height", n)
    }
    function r(e) {
        for (var t = e.translateResult, n = [], r = 0, i = O(A.state.type) ? " " : "", o = 0; o < t.length; o++) {
            var a = t[o]
              , s = [];
            r += a.length;
        ...
        v.clog("&sentence_number=" + r + "&type=" + A.state.type);
        var f = n.join("");
        x.html(f),
        A.state.originalTgt = x.text(),
        A.state.smallFont ? x.addClass("input__target__text--small") : x.removeClass("input__target__text--small")
    }
    function i() {
        var e = u.trim(b.val());
        e = e.replace(/\n/g, "").replace(/\r\n/g, ""),
        location.href = "http://fanyi.youdao.com/WebpageTranslate?keyfrom=fanyi.web.index&url=" + encodeURIComponent(e) + "&type=" + u("#customSelectVal").val()
    }
    function o(e) {
        if (0 == u('li[data-value="' + e + '"]').length)
            u("#langSelect").selectValue("AUTO");
        else {
            u("#langSelect").selectValue(e);
            var t = u(".select-text").text();
            A.state.isSelectLan || u(".select-text").text("检测到：" + t)
        }
    }
    function a(e) {
        e && 0 == e.errorCode ? (A.state = u.extend(A.state, e),
        o(A.state.type),
        r(e),
        e.smartResult && e.translateResult.length > 0 && e.translateResult[0].length > 0 ? (v.clog("RESULT_DICT_SHOW"),
        g.render(e.translateResult[0][0].src, e.smartResult)) : g.hide(),
        d.showVoice(A.state.type)) : x.html(""),
        L()
    }
    function s(e, t) {
        if (A.state.originalText = e.i,
        "first" == e.action)
            return a(global.translatedJson),
            void t();
        p && (p.abort(),
        p = null),
        p = u.ajax({
    ...
    function l(e, t) {
        "zh-CHS2en" != A.state.type && "en2zh-CHS" != A.state.type || (u(e).hasClass("show-suggest") ? c() : (u(e).addClass("show-suggest"),
        j.hide(),
        y.asyRequest({
            i: t.i,
            client: S,
            ...
            success: function(t) {
                ...
                var o = t.translateResult
                  , a = [];
                v.clog("&mul_result_number=" + o.length + "&type=" + A.state.type);
                for (var s = 0; s < o.length; s++) {
                    var l = o[s].tgt
                      , c = o[s].systemName;
                    a.push('<li systemName="' + c + '">' + l + "</li>")
                }
                j.find("ul").html(a.join("")),
                j.css("top", n + i + 10),
                j.css("left", r),
    ...
    function c() {
        u(".show-suggest").removeClass("show-suggest"),
        j.hide()
    }
    var u = e("./jquery-1.7")
      , f = e("./utils")
    ...
    var v = e("./log")
      ...
      , O = function(e) {
        return "zh-CHS2en" === e || "zh-CHS2fr" === e || "zh-CHS2ru" === e || "zh-CHS2pt" === e || "zh-CHS2es" === e || "zh-CHS2vi" === e
    }
      , L = function() {
        var e = A.state.getFromTo();
        _ = e[0],
        C = e[1]
    };
    !function() {
        function e(e, t) {
            for (var n = 0, r = A.state.translateResult, i = 0; i <= e; i++) {
                var o = r[i].length;
                i == e && (o = t);
                for (var a = 0; a < o; a++)
                    n += r[i][a].src.length
        ...
        function t(e) {
            var t = e.position().top
              , n = e.position().left
              , i = e.width();
            "zh-CHS2en" != A.state.type && "en2zh-CHS" != A.state.type || (u(".fanyi__update__tip").css({
        ...
        function r() {
            k && (clearTimeout(k),
            k = "",
            u(".fanyi__update__tip").stop(!0, !0)),
            u(".fanyi__update__tip").hide()
        }
        function i() {
            E && (clearInterval(E),
            E = "")
        ...
        function o() {
            ...
            E = setInterval(function() {
                null == f.getSelectionText() && (i(),
                h = !1)
            }, 100)
        }
        x.delegate("span", "mouseover", function() {
            if (!h) {
                var n = u(this)
                  , r = n.attr("data-section")
                  , i = n.attr("data-sentence")
                  , o = A.state.translateResult[r][i].src
                  , a = e(r, i)
                ...
                t(n),
                u("#transTarget span.hover").removeClass("hover"),
                n.addClass("hover"),
                v.clog("MATCHING_HOVER&type=" + A.state.type)
            }
        }),
        x.delegate("span", "click", function() {
            if (!h) {
                var t = u(this)
                  , n = t.attr("data-section")
                  , r = t.attr("data-sentence")
                  , i = A.state.translateResult[n][r].src
                  , o = A.state.translateResult[n][r].tgt
                  , a = e(n, r)
                ...
                v.clog("MUL_RESULT_CLICK&type=" + A.state.type);
                var c = A.state.getDetectedFromTo()[0]
                  , f = A.state.getDetectedFromTo()[1];
                l(t, {
                    i: i,
                    tgt: o,
                    from: c,
        ...
        u("#fanyiSuggest").delegate("li", "click", function() {
            var e = A.state.updateEle
              , t = u(this).text()
              , r = u(this).attr("systemName")
              , i = u(this).index();
            A.state.isUpdate = !0,
            e.text(t),
            n(),
            e.addClass("updated");
            var o = A.state.updateEle
              , a = o.attr("data-section")
              , s = o.attr("data-sentence")
              , l = A.state.translateResult[a][s].src
              , c = A.state.translateResult[a][s].tgt
              , f = A.state.getDetectedFromTo()[0]
              , d = A.state.getDetectedFromTo()[1];
            m.recordMoreResultLog_choose({
                i: l,
                tgt: c,
                systemName: r,
                pos: i,
        ...
        u("body").on("click", function(e) {
            var t = u(e.target);
            0 != t.parents("#transTarget").length && "SPAN" == t[0].tagName || (u("#transTarget .will-update").removeClass("will-update"),
            c())
        }),
        u(".suggest__title--close").on("click", function() {
            c()
        }),
        x.delegate("span", "mouseout", function() {
            h || (u("#transTarget span.hover").removeClass("hover"),
            N || b.selectRange({
                start: 0,
                end: 0
            }),
        ...
        u(".input__target").on("mouseup", function(e) {
            null == f.getSelectionText() && (h = !1),
            o()
        }),
        u(".suggest__update__btn").on("click", function() {
            v.clog("RESULT_SINGEL_MODIFY_CLICK"),
            u("#updateResult").trigger("click", [!0])
        })
    }(),
...
define("newweb/index", ["./common/log", "./common/account", "./common/hotLink", "./common/download", "./common/utils", "./common/voice", "./common/TranslateState", "./operations", "./langSelect", "./common/star", "./common/select", "./common/manTranslate", "./input", "./common/textAuto", "./common/translate", "./common/service", "./common/md5", "./common/jquery-1.7", "./common/smartResult", "./common/requestMoreTrans", "./common/docTrans", "./common/form", "./common/copy", "./common/ZeroClipboard", "./common/updateResult"], function(e) {
...
define("newweb/input", ["./common/textAuto", "./common/translate", "./common/utils", "./common/voice", "./common/TranslateState", "./common/log", "./common/service", "./common/md5", "./common/jquery-1.7", "./common/smartResult", "./common/requestMoreTrans", "./common/star", "./common/docTrans", "./common/form", "./common/account", "./langSelect", "./common/select"], function(e, t) {
    function n() {
        var e = u.val()
          , t = 0
          , n = 0
